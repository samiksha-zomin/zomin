          ...
          {authState.admin === 1 ? (
            <Row className="mx-5">
              <Col sm={12} className="mx-auto my-2">
                <Heading content="Partner" design="h4" />
              </Col>
              <Col sm={12} className="mx-auto my-2">
                <MaterialTable
                  title="Partner"
                  ...
                  editable={{
                    onRowUpdate: (newRow, oldRow) =>
                      new Promise((resolve, reject) => {
                        Axios.patch(
                          `${process.env.REACT_APP_SERVER_DOMAIN}/zomAdminPartner`,
                          newRow
                        ).then((response) => {
                  ...
                  actions={[
                    {
                      ...
                      onClick: (e, data) => {
                        Axios.patch(
                          `${process.env.REACT_APP_SERVER_DOMAIN}/zomAdminPartner/showLanding`,
                          data
                        ).then((response) => {
                          if (response.data.error) {
                            return toast.error(
                    ...
                    },
                    {
                      ...
                      onClick: (e, data) => {
                        Axios.patch(
                          `${process.env.REACT_APP_SERVER_DOMAIN}/zomAdminPartner/hideLanding`,
                          data
                        ).then((response) => {
                          if (response.data.error) {
                            return toast.error(
