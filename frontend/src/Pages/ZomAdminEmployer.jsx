import React, {
  ...
  function ZomAdminEmployer() {
    ...
    useEffect(() => {
      Axios.get(`${process.env.REACT_APP_SERVER_DOMAIN}/zomAdminEmployer/`, {
        headers: {
    ...
    const columns = [
        ...
        { title: "Employer Name", field: "companyname" },
        { title: "Industry", field: "industry" },
        { title: "BP Status", field: "publish", align: "center", lookup: { 1: <BiCheckCircle className="text-success" size={28}/>, 0: <BiXCircle className="text-danger" size={28} /> } },
        {
          title: "Status",
          field: "status",
          align: "center",
  ...
  export default ZomAdminEmployer;