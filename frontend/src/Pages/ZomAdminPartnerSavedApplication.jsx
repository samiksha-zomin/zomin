...
function ZomAdminPartnerSavedApplication() {
  ...
  useEffect(() => {
    Axios.get(
      `${process.env.REACT_APP_SERVER_DOMAIN}/zomAdminPartnerSavedApplication/`,
      {
        headers: {
          ...
          {authState.admin === 1 ? (
            <Row className="mx-5">
              <Col sm={12} className="mx-auto my-2">
                <Heading content="Partner Saved Application" design="h4" />
              </Col>
              <Col sm={12} className="mx-auto my-2">
                <MaterialTable
                  title="Partner Saved Application"
                  columns={columns}
                  icons={tableIcons}
                  data={userList}
                  options={{
                  ...
                  actions={[
                    {
                      ...
                      onClick: (e, data) => {
                        Axios.patch(
                          `${process.env.REACT_APP_SERVER_DOMAIN}/zomAdminPartnerSavedApplication/bePartner`,
                          data
                        ).then((response) => {
                          if (response.data.error) {
                            return toast.error(
...
export default ZomAdminPartnerSavedApplication;